...
{
public:
	// Evaluate expression to u64 given the context of no valid thread.
	u64 evaluate_null_u64(const QString& expression);

	// Evaluate expression to bool given the context of no valid thread.
	bool evaluate_null_bool(const QString& expression);
