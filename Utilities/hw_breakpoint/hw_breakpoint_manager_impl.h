...
public:
	// Todo(TGEnigma): move to general utility?
	...
	inline static void set_debug_control_register_bits(u64* reg, u32 index, hw_breakpoint_type type, hw_breakpoint_size size, bool enable)
	{
